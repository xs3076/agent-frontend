  ...
  useMount(async () => {
    try {
      if (props.data.code) {
        ...
        setState({
          input: {
            system_params: componentDetailCfg.input?.system_params || [],
            user_params: componentDetailCfg.input?.user_params || [],
          },
        ...
        setState({
          input: {
            system_params: componentParams.input?.system_params || [],
            user_params: componentParams.input?.user_params || [],
          },
